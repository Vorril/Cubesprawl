...
//put those in the program settings tools menu

#include <stdio.h>
#include <vec4VBO.h>

#include <objectLib.h>//glew
#include <textureLib.h>//soil
...
public:
	...
	static void loadTerrain(const char* filePath, vec4VBO loadME){
