...
void Camera::rotateCameraHorz(float angle){
	lookDirection = matrix3::makeRotateYaxis(angle)*lookDirection;
...
void Camera::rotateCameraVert(float angle){
	...
	if (lookDirection[1] * lookDirection[1] > 0.98f) lookDirection = lookCopy;//undo went too extreme//TODO BETTER
